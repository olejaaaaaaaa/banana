...
use crate::{AttributeDescriptions, BindingDescriptions, GraphicsPipelineBuilder, LayoutHandle, PassBuilder, PassContext, Pipeline, PipelineLayoutBuilder, RenderContext, RenderGraphBuilder, RenderTarget, ResourceManager, Vertex};

pub struct SimpleRenderer {
    frame_buffer: Option<bool>,
    layout: LayoutHandle
}
...
impl SimpleRenderer {
    ...
    pub fn new(ctx: &RenderContext, res: &mut ResourceManager, builder: &mut RenderGraphBuilder) -> Self {
        ...
        let layout = res.add_layout(layout);
        ...
        SimpleRenderer { frame_buffer: None, layout }
    }
}
